...
# element_size is the dimension of each vector in our sequence
# time_steps is the number of elements in a sequence
element_size = 28
time_steps = 28
num_classes = 10
batch_size = 128
...
# This helper function, taken from the offical Tensorflow documention
# simply adds some ios that take care of logging summaries
...
# Processing inputs to work with scan functions
# Current input shape: (batch_size, time_steps, element_size)
processed_input = tf.transpose(_inputs, perm=[1, 0, 2])
# Current inpur shape now: (time_steps, batch_size, element_size)
